...
resource "aws_launch_template" "app1_LT_443" {
  ...
  user_data = base64encode(<<-EOF
    ...
    <body>
    <div>
    <h1>Class 6 Cloud Warriors are secure</h1>
    <h1>Some where in Tokyo</h1>
    <p><b>Instance Name:</b> $(hostname -f) </p>
    <p><b>Instance Private Ip Address: </b> $local_ipv4</p>
    <p><b>Availability Zone: </b> $az</p>
    <p><b>Virtual Private Cloud (VPC):</b> $vpc</p>
...
resource "aws_launch_template" "app2_LT_443" {
  ...
  vpc_security_group_ids = [aws_security_group.app2-sg03-secure-servers.id]
...
resource "aws_launch_template" "app3_LT_443" {
  ...
  vpc_security_group_ids = [aws_security_group.app3-sg03-secure-servers.id]
...
resource "aws_launch_template" "app4_LT_443" {
  ...
  vpc_security_group_ids = [aws_security_group.app4-sg03-secure-servers.id]
...
resource "aws_launch_template" "app5_LT_443" {
  ...
  vpc_security_group_ids = [aws_security_group.app5-sg03-secure-servers.id]
...
resource "aws_launch_template" "app6_LT_443" {
  ...
  vpc_security_group_ids = [aws_security_group.app6-sg03-secure-servers.id]
...
resource "aws_launch_template" "app7_LT_443" {
  ...
  vpc_security_group_ids = [aws_security_group.app7-sg03-secure-servers.id]
  ...
  user_data = base64encode(<<-EOF
    ...
    <div>
    <h1>Class 6 Cloud Warriors are secure</h1>
    <h1>Some where in CALIFORNIA</h1>
    <p><b>Instance Name:</b> $(hostname -f) </p>
    <p><b>Instance Private Ip Address: </b> $local_ipv4</p>
    <p><b>Availability Zone: </b> $az</p>
    <p><b>Virtual Private Cloud (VPC):</b> $vpc</p>
